...
import com.nearnia.encouragement.adapters.OtherWrittenAdapter;
...
public class OwnWrittenFragment_Other extends Fragment implements SwipeRefreshLayout.OnRefreshListener, IAsyncResponse {
	...
	OwnWrittenAdapter owa;
	QuotesYouLiked quoteyouLoved;

	public static final OwnWrittenFragment_Other newInstance(String message) {

		OwnWrittenFragment_Other f = new OwnWrittenFragment_Other();
	...
	private void fetchData() {
		...
		String url = VolleySingleton.QUOTES_YOU_WRITTEN_URL
				+ VolleySingleton.userLogin.getString("USERID_RECIEVED", "0");
	...
	public void onRestIntractionResponse(String response) {
		...
		if (jsonObject.has("data")) {
			...
			OtherWrittenAdapter q = new OtherWrittenAdapter(getActivity(), arraylist);
