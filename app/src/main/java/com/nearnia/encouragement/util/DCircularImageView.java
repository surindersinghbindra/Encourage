...
//https://github.com/Pkmmte/CircularImageView/blob/master/circularimageview-sample/src/main/res/layout/row.xml
...
public class DCircularImageView extends ImageView {
	...
	public DCircularImageView(Context context) {
		this(context, null);
	}

	public DCircularImageView(Context context, AttributeSet attrs) {
		this(context, attrs, R.attr.circularImageViewStyle);
	}

	public DCircularImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray attributes = context.obtainStyledAttributes(attrs,
				R.styleable.DCircularImageView, defStyle, 0);

		// Check if border and/or border is enabled
		hasBorder = attributes.getBoolean(
				R.styleable.DCircularImageView_border, false);
		hasSelector = attributes.getBoolean(
				R.styleable.DCircularImageView_selector, false);
		...
		if (hasBorder) {
			...
			setBorderWidth(attributes.getDimensionPixelOffset(
					R.styleable.DCircularImageView_border_width,
					defaultBorderSize));
			setBorderColor(attributes.getColor(
					R.styleable.DCircularImageView_border_color, Color.WHITE));
		}
		...
		if (hasSelector) {
			...
			setSelectorColor(attributes.getColor(
					R.styleable.DCircularImageView_selector_color,
					Color.TRANSPARENT));
			setSelectorStrokeWidth(attributes.getDimensionPixelOffset(
					R.styleable.DCircularImageView_selector_stroke_width,
					defaultSelectorSize));
			setSelectorStrokeColor(attributes.getColor(
					R.styleable.DCircularImageView_selector_stroke_color,
					Color.BLUE));
		}

		// Add shadow if enabled
		if (attributes.getBoolean(R.styleable.DCircularImageView_shadow, false))
			addShadow();
	...
	/**
	 * Sets the DCircularImageView's border width in pixels.
	 * 
	 * @param borderWidth
	 */
	...
	/**
	 * Sets the DCircularImageView's basic border color.
	 * 
	 * @param borderColor
	 */
	...
	/**
	 * Sets the color of the selector to be draw over the DCircularImageView. Be
	...
	/**
	 * Sets the stroke width to be drawn around the DCircularImageView during
	...
	/**
	 * Sets the stroke color to be drawn around the DCircularImageView during
	 * click events when the selector is enabled.
	 * 
	 * @param borderColor
	 */
	...
	/**
	 * Adds a dark shadow to this DCircularImageView.
	 */
