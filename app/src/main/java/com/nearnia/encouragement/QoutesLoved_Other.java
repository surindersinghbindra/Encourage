...
import com.nearnia.encouragement.adapters.QoutesOtherLovedAdapter;
...
public class QoutesLoved_Other extends Fragment implements OnClickListener, IAsyncResponse {

	private ArrayList<QuotesYouLiked> arraylist;
	private QoutesOtherLovedAdapter q;
	private Spinner sp;
	...
	QuotesYouLiked quoteyouLoved;

	private View v2;

	public QoutesLoved_Other() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		quoteyouLoved = (QuotesYouLiked) UniversalSingleton.getInstance().getObject();
		...
		String url = VolleySingleton.LIKE_QOUTE_URL + VolleySingleton.userLogin.getString("USERID_RECIEVED", "0");
	...
	public void onClick(View v) {
		...
		case R.id.serachfragment_search_clear:
			...
			fetchData(VolleySingleton.LIKE_QOUTE_URL + "&userid="
					+ VolleySingleton.userLogin.getString("USERID_RECIEVED", "0") + "&search="
	...
	public void onRestIntractionResponse(String response) {
		...
		if (jsonObject.has("data") && jsonArray.length() > 0) {
			...
			q = new QoutesOtherLovedAdapter(getActivity(), arraylist);
			...
			sp.setOnItemSelectedListener(new OnItemSelectedListener() {
				...
				public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
					...
					if (position == 0) {
						...
						String url = VolleySingleton.LIKE_QOUTE_URL
								+ String.valueOf(VolleySingleton.userLogin.getString("USERID_RECIEVED", "0"));
					...
					if (position == 1) {
						...
						String url = VolleySingleton.LIKE_QOUTE_URL
								+ VolleySingleton.userLogin.getString("USERID_RECIEVED", "0") + "&filter=1";
					...
					if (position == 2) {
						...
						String url = VolleySingleton.LIKE_QOUTE_URL
								+ VolleySingleton.userLogin.getString("USERID_RECIEVED", "0") + "&filter=2";
					...
					if (position == 3) {
						...
						String url = VolleySingleton.LIKE_QOUTE_URL
								+ VolleySingleton.userLogin.getString("USERID_RECIEVED", "0") + "&filter=3";
				...
				public void onNothingSelected(AdapterView<?> parent) {
					...
					// subChannelId =
					// all_Sub_Categories.get(0).getSubChannelId();
