...
public class OtherUserMainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.fragment_container) != null) {
			...
			getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, otherUserProfile).commit();
		}
	...
	public void onBackPressed() {
		...
		FragmentManager fm = OtherUserMainActivity.this.getSupportFragmentManager();
			...
			new AlertDialog.Builder(this).setMessage("Are you sure you want to exit?").setCancelable(false)
					.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int id) {
							...
							OtherUserMainActivity.this.finish();
						}
