...
public class QoutesOtherLovedAdapter extends BaseAdapter implements Filterable {
	...
	public QoutesOtherLovedAdapter(Context ctx, ArrayList<QuotesYouLiked> arraylist) {
		this.mContext = ctx;
...
//				VolleySingleton.userLogin.edit().putBoolean("NOTIFICATION_RECIEVED", true).commit();
				// VolleySingleton.userLogin.edit().putString("USERID_RECIEVED",
